                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tbody >
                        <tr v-if="dataList != ''" v-for="(val, index) in dataList" :key="index">
                            ...
                            <td v-text="val.query_count"></td>
                            <td v-text="val.success_count"></td>
                            <td v-text="val.car_error_count"></td>
                            <td v-text="val.interface_error_count"></td>
                            <td v-text="val.limit_count"></td>
                            <td v-text="val.license_count"></td>
                            <td v-text="val.license_sucess_count"></td>
                        </tr>
                        <tr v-if="dataList">
                            <td>总计</td>
                            <td v-text="total('query_count')"></td>
                            <td v-text="total('success_count')"></td>
                            <td v-text="total('car_error_count')"></td>
                            <td v-text="total('interface_error_count')"></td>
                            <td v-text="total('limit_count')"></td>
                            <td v-text="total('license_count')"></td>
                            <td v-text="total('license_sucess_count')"></td>
                        </tr> 
                        <tr v-if="dataList == ''">
...
export default {
    ...
    methods: {
        ...
        query: function(){
            ...
            this.$http.post(
                this.$api.payment.queryStatistic,
                {
        ...
        exportFile:function(){
            ...
            var beginDateVal = document.getElementById("beginDate").value;
            var endDateVal = document.getElementById("endDate").value;
            this.$export(this.$api.payment.exportStatistic, {
                'tp_query_type' : channelVal,
                'quey_begin_date': beginDateVal,
                'query_end_date'  : endDateVal
            })
